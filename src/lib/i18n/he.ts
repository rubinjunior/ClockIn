export const he = {
  ...
  dashboard: { title: "היום שלך", week: "סיכום השבוע", recent: "דיווחים אחרונים", vacation: "יתרת חופשה", sick: "יתרת מחלה", reminder: "התזכורת הבאה", noEntries: "עדיין אין דיווחים להיום" },
